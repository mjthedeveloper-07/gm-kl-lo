...
export const ImportHistoricalData = () => {
  ...
  const [selectedYears, setSelectedYears] = useState<number[]>([2019, 2020, 2021, 2022, 2023, 2024, 2025]);
    ...
    <Card className="border-2 border-primary/20 shadow-lg">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Import Complete Historical Data (2019-2025)
        </CardTitle>
        <CardDescription>
          Import comprehensive lottery results from 2019 to 2025 for enhanced predictions
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="bg-muted/50 p-4 rounded-lg space-y-3">
          ...
          <div className="pt-2 border-t">
            <p className="text-xs text-muted-foreground">
              Complete historical coverage from {historicalStats.dateRange.start} to {stats2025.dateRange.end}
            </p>
          </div>
        </div>
        ...
        <p className="text-xs text-center text-muted-foreground">
          This will import all lottery results from selected years.
